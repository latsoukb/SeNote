...
const NotebookEditor = () => {
  ...
  return (
    <div className="h-dvh flex flex-col overflow-hidden">
      ...
      <header className="shrink-0 flex items-center justify-between px-4 py-3 border-b border-slate-200 dark:border-chrome-800 bg-white dark:bg-chrome-950 z-40">
        <div className="flex items-center gap-3 min-w-0">
          ...
          <Logo size="sm" />
          <div className="h-6 w-px bg-slate-200 dark:bg-chrome-800 mx-2" />
          {editingTitle ? (
            <Input
              value={titleDraft}
            ...
            <button
              ...
              className="font-medium text-sm hover:bg-slate-100 dark:hover:bg-chrome-800 px-2 py-1 rounded-md truncate max-w-[30vw]"
            >
              {notebook.title}
            </button>
          )}
                  ...
                  <button
                    ...
                    className={`flex-1 text-xs py-1.5 rounded-md border transition-colors ${
                      addPageMode === m.id
                        ...
                        : 'border-slate-200 dark:border-chrome-700 hover:bg-slate-100 dark:hover:bg-chrome-800'
                    }`}
                  >
                    {m.label}
                  </button>
      ...
      <div className="flex flex-1 min-h-0">
        {sidebarOpen && (
          <aside className="w-56 border-r border-slate-200 dark:border-chrome-800 bg-slate-50 dark:bg-chrome-900/50 flex flex-col shrink-0">
            ...
            <div className="flex items-center justify-between px-3 py-2 border-b border-slate-200 dark:border-chrome-800 gap-1">
              ...
              <Popover open={notebookTemplateOpen} onOpenChange={setNotebookTemplateOpen}>
                <PopoverTrigger asChild>
                  <button
                    className="p-1 rounded hover:bg-slate-200 dark:hover:bg-chrome-800"
                  ...
                  <div className="absolute top-1 right-1 flex gap-0.5 opacity-0 group-hover:opacity-100 transition-opacity">
                    ...
                    >
                      <PopoverTrigger asChild>
                        <button
                          ...
                          className="p-1 rounded bg-white/90 dark:bg-chrome-800/90 text-slate-600"
                    ...
                    {pages.length > 1 && (
                      <button
                        ...
                        className="p-1 rounded bg-white/90 dark:bg-chrome-800/90 text-red-500"
