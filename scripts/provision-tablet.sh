...
echo ""
echo "  Prochaines étapes sur la tablette (Paramètres, roue dentée) :"
echo "  1. Connexion Wi‑Fi"
echo "  2. Verrouillage de la tablette (PIN au choix de l'élève)"
echo "  3. Mise à jour SeNote quand disponible"
echo ""
